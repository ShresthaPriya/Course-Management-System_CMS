...
public class StudentsListForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StudentsListForm
     */
...
//        getAllCourseValues();
    ...
    private void setupTableValues() {
        ...
        try {
            ...
            while (rs.next()) {
                String studentId = String.valueOf(rs.getString("id"));
                String fistName = String.valueOf(rs.getString("firstname"));
                String lastName = rs.getString("lastname");

                String tbData[] = {studentId, fistName, lastName};
    ...
    private void initComponents() {
        ...
        jButton1.setText("Generate Student Report");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        StudentReportForm form = new StudentReportForm(studentId);
